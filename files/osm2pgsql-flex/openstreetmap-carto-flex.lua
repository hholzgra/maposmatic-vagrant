-- This file was taken from openstreetmap-carto repository
-- with the following added to it
--
-- * for the Belgian openstreetmap-carto-be style:
-- * * "craft" and "industrial" points / polygons
--
-- * for the "Baumkarte" style:
-- * * "allotment" points / polygons
